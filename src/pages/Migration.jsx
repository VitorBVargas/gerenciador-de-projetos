              ...
              <Card className="bg-slate-800/50 border-slate-700/50">
                <CardHeader className="border-b border-slate-700/50">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className={cn(
                      "border",
                      getProductProgress(selectedProduct.id) === 100 
                        ? "bg-green-500/20 text-green-400 border-green-500/30"
                        : "bg-orange-500/20 text-orange-400 border-orange-500/30"
                    )}>
                      {getProductProgress(selectedProduct.id)}% Migrado
                    </Badge>
                  </div>
                </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    {getProductTasks(selectedProduct.id).length === 0 && (
                      <p className="text-center text-slate-500 py-8">
                        Nenhuma tarefa cadastrada. Adicione tarefas de migração.
                      </p>
                    )}
                  </div>
                </CardContent>
              ...
              <Card className="bg-slate-800/50 border-slate-700/50">
                <CardContent className="py-12">
                  <EmptyState
                    ...
                    description="Escolha um produto na lista para gerenciar o checklist de migração"
                  />
                </CardContent>
              </Card>
            )}
