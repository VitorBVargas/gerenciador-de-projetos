// Tarefas de homologação para produtos de educação e especializados
...
export const productHasEducationTasks = (productName) => {
  return getEducationTasksForProduct(productName) !== null;
};