...
export const migrationTasksByProduct = {
  ...
  'e-Nota (Cloud)': parseTasksIntoSections([
    ...
    'Simples Nacional',
    'Serviços Pessoa',
    'Serviço Contribuinte Prestador',
    'DADOS DE LANÇAMENTOS',
    'Autorização de Emissão de NF',
    'Notas Fiscais',
    'XML Notas Fiscais',
    'Serviços de Notas Fiscais',
    'Cancelamento Nota',
    'Substituição Nota / Estorno',
    'Guias de Pagamentos',
    'Guias de Notas'
  ]),
  ...
  'Livro Eletrônico': parseTasksIntoSections([
    ...
    'Contadores',
    'Indexadores',
    'Valores de Indexadores',
    'Contribuintes',
    'Lista de Serviços',
    'Contribuintes Serviços',
    'Movimento Optante Simples',
    'Tomadores e Prestadores',
    'DADOS DE LANÇAMENTOS',
    'Guias',
    'Guias das Declarações',
    'Declarações',
    'Documentos Fiscais das Declarações',
