...
export const getDefaultTasksForProduct = (productName) => {
  ...
  'Ponto (Cloud)': parseTasksIntoSections([
    ...
    'Extrair Concursos Públicos e Processo Seletivos',
    'Extrair Edital de Concurso',
    'Extrair Cargos dos Concursos Públicos e Processos Seletivos',
    'Extrair Concurso Processo Seletivo Cargo Vaga',
    'Extrair Concurso Processo Seletivo Cargo Avaliação',
    'Extrair Concurso Processo Seletivo Candidato',
    'Extrair Concurso Processo Seletivo Candidato Avaliação',
    'Extrair Concurso Processo Seletivo Candidato Avaliação Questão',
    'Extrair Concurso Processo Seletivo Cargo Classificação',
    'Extrair Concurso Processo Seletivo Candidato Classificação',
    'Extrair Candidatos dos Concursos Públicos e Processos Seletivos',
    'Extrair Convocação dos Candidatos dos Concursos Públicos e Processos Seletivos',
    'Extrair Solicitação de Equipamento de Proteção',
    'Extrair Configuração de Planos de Saúde',
    'Extrair Verba para Empréstimo',
    'Extrair Rotas',
    'Extrair Vale Transporte',
    'Extrair Benefícios',
    'Extrair Procedimentos Médicos',
    'Extrair Despesas com Procedimentos Médicos',
    'Extrair Despesas com Planos de Saúde',
    'Extrair Configuração de Licença Prêmio',
    'Extrair Configuração de Adicional',
    'Extrair Matrícula Adicional',
    'Extrair Matrícula Licença Prêmio',
    'Extrair Experiência Anterior',
    'Extrair Averbação',
    'Extrair Averbação Matrícula',
    'Extrair Junta Médica',
    'Extrair Laudo Médico',
    'Extrair CIPA',
    'Extrair PPRA',
    'Extrair Acidente de Trabalho',
    'Extrair Atendimento de Acidente de Trabalho',
    'Extrair Risco Ambiental',
    'Extrair ASO',
    'Extrair ASO Procedimento',
    'Extrair Comissões de Avaliação',
    'Extrair Conceitos de Avaliação de Desempenho',
    'Extrair Competências de Avaliação de Desempenho',
    'Extrair Configuração de Avaliação de Desempenho',
    'Extrair Desempenho Avaliador',
    'Extrair Desempenho Avaliações',
    'Extrair Período Aquisitivo de Adicional',
    'Extrair Período Aquisitivo de Licença Prêmio',
