...
import AgilStartAssistant from './pages/AgilStartAssistant';
 ...
 return (
    <Routes>
      ...
      <Route path="/PendenciaEdital" element={
        <LayoutWrapper currentPageName="PendenciaEdital">
          <PendenciaEdital />
        </LayoutWrapper>
      } />
      ...
      <Route path="/AgilStartAssistant" element={
        <LayoutWrapper currentPageName="AgilStartAssistant">
          <AgilStartAssistant />
        </LayoutWrapper>
      } />
